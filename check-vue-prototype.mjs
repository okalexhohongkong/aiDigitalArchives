...
const requiredText = [
  ...
  ["界面原型-vue/src/components/DocumentPreview.vue", ["selectedDocument.controls", "control.includes", "授权查看", "分级导出", "预览授权策略联动", "授权前置条件", "预览安全边界", "预览授权台账", "仅模拟授权不打开真实文件", "simulatePreviewAuthorization"]],
