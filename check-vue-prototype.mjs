...
const requiredText = [
  ...
  ["界面原型-vue/src/styles/responsive.css", ["@media", "max-width: 900px", "max-width: 390px", "grid-template-columns", "overflow-wrap", "permission-ledger", "audit-filter-row", "settings-policy-grid", "governance-ledger"]],
];
