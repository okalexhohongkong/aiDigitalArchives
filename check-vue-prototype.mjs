...
const requiredText = [
  ...
  ["界面原型-vue/src/components/DocumentPreview.vue", ["selectedDocument.controls", "control.includes", "授权查看", "分级导出", "预览授权策略联动", "授权前置条件", "预览安全边界", "预览授权台账", "仅模拟授权不打开真实文件", "simulatePreviewAuthorization", "preview-audit", "仅记录模拟审计不触碰真实文件"]],
  ...
  ["界面原型-vue/src/styles/responsive.css", ["@media", "max-width: 900px", "max-width: 390px", "grid-template-columns", "overflow-wrap", "permission-ledger", "audit-filter-row", "settings-policy-grid", "governance-ledger", "preview-policy-grid", "preview-audit-ledger"]],
];
