...
const requiredText = [
  ...
  ["界面原型-vue/src/App.vue", ["SidebarNav", "AppHeader", "SearchCommand", "QuickCategoryGrid", "DocumentPreview", "OrgStructureExplorer", "AccessPolicyMatrix", "LocalIndexPanel", "SettingsHub", "ImportExportGovernance", "QueryBillingPanel", "ApprovalWorkflowPanel", "ProgressSnapshot"]],
  ["界面原型-vue/src/data/dashboard.js", ["BG AI DAMS", "老板个人档案", "家庭档案", "公司档案", "在职档案", "离职档案", "经典作品", "合同案例", "模糊搜索", "精准搜索", "全文搜索", "积分兑换", "双人共同查看", "摄像头", "防偷拍水印", "水印", "董事会办公室", "历史组织架构图", "L6 绝密", "不可浏览", "公众浏览防偷拍", "AI 接入", "平台接入", "备份容灾", "导入必须查毒", "导出分级授权", "查询付费", "积分余额", "查看审批", "下载审批", "导出审批"]],
  ...
  ["界面原型-vue/src/components/LocalIndexPanel.vue", ["本机索引只读展示", "archive-index-data.js", "路径脱敏", "hasLocalPath", "关键词搜索", "密级筛选", "格式筛选", "filteredArchives"]],
  ["界面原型-vue/src/components/SettingsHub.vue", ["系统设置", "AI 接入", "平台接入", "备份容灾", "加密文件策略"]],
  ["界面原型-vue/src/components/ImportExportGovernance.vue", ["导入必须查毒", "导出分级授权", "双人授权", "台账留痕"]],
  ["界面原型-vue/src/components/QueryBillingPanel.vue", ["查询积分兑换", "查询付费", "积分余额", "扣费规则"]],
  ["界面原型-vue/src/components/ApprovalWorkflowPanel.vue", ["权限审批流程", "查看审批", "下载审批", "导出审批", "双人共同查看"]],
