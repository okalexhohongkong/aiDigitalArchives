...
const requiredText = [
  ...
  ["界面原型-vue/src/App.vue", ["SidebarNav", "AppHeader", "SearchCommand", "QuickCategoryGrid", "DocumentPreview", "ProgressSnapshot"]],
  ["界面原型-vue/src/data/dashboard.js", ["BG AI DAMS", "老板个人档案", "家庭档案", "公司档案", "在职档案", "离职档案", "经典作品", "合同案例", "模糊搜索", "精准搜索", "全文搜索", "积分兑换", "双人共同查看", "摄像头", "防偷拍水印", "水印"]],
